...
<body>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-2 hidden" id="refreshBtnContainer">
                                    <a id="searchNameBtn" style="margin-top: 30px;" href="?tag=faculty_lecturer_report&op=search&faculty=<?php echo $faculty = isset($_GET['faculty']) ? $_GET['faculty'] : null; ?> "class="btn btn-primary">Refresh</a>
                                </div>
        ...
        <?php
        if (isset($_GET['op']) && $_GET['op'] == 'search' && isset($_GET['tag']) && $_GET['tag'] == 'faculty_lecturer_report') {
            ...
            if ($faculty !== null && $faculty !== '') {
                $query = "SELECT * FROM `schedule_tbl` 
                    ...
                    WHERE faculty_tbl.FacultyID=$faculty";
                ...
                if ($result) {
                    ...
                    echo '<div class="text-center"><h1>REPORT LECTURER TEACH BY FACULTY</h1></div>';
    ...
    <script>
        document.getElementById('searchMajorBtn').addEventListener('click', function(event) {
            ...
            var url = '?tag=faculty_lecturer_report&op=search';
        ...
        document.getElementById('searchNameBtn').addEventListener('click', function(event) {
            ...
            var batch = document.getElementById('faculty').value;
            if (!faculty) {
