...
<body>
    <main id="main" class="main">
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Attended Report by Date Range</h5>
                            <div class="row g-2">
                                <div class="col-2">
                                ...
                                <div class="col-2 hidden" id="refreshBtnContainer">
                                    <a id="searchNameBtn" style="margin-top: 30px;" href="?tag=day_attended_stu&op=search&startDate=<?php echo $startDate = isset($_GET['startDate']) ? $_GET['startDate'] : null; ?>&endDate=<?php echo $endDate = isset($_GET['endDate']) ? $_GET['endDate'] : null; ?> "class="btn btn-primary">Refresh</a>
                                </div>
        ...
        <?php
        if (isset($_GET['op']) && $_GET['op'] == 'search' && isset($_GET['tag']) && $_GET['tag'] == 'day_attended_stu') {
            ...
            if ($startDate !== null && $endDate !== null) {
                ...
                WHERE attendance_tbl.Attended = 1 AND attendance_tbl.AttendanceDateIssue BETWEEN '$startDate' AND '$endDate'";
                ...
                if ($result) {
                    ...
                    echo '<div class="text-center"><h1>STUDENT ATTENDED BY DATE</h1></div>';
    ...
    <script>
        document.getElementById('searchDateBtn').addEventListener('click', function(event) {
            ...
            var url = '?tag=day_attended_stu&op=search';
