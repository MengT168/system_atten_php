    ...
    function Insert_Edu(){
                ...
                if(isset($_POST['btn_add_status'])){
                    ...
                    $studenttxt = $_POST['studenttxt'];
                        ...
                        if (!empty($schooltype) && !empty($schoolnametxt) && !empty($academicyear) && !empty($province) && !empty($studenttxt)  ) {
                            $sql_ins1 = "INSERT INTO `educationalbackground_tbl`( `SchoolTypeID`, `NameSchool`, `AcademicYear`, `Province`, `StudentID`) VALUES
                     ('$schooltype','$schoolnametxt','$academicyear','$province','$studenttxt')";
    ...
    function updatePro(){
        ...
        if(isset($_POST['btn_up_pro'])){
            ...
            SET `SchoolTypeID`='$schooltytxt',
                    ...
                    `Province`='$cityprovince' WHERE EducationalBackgroundID = $id";
