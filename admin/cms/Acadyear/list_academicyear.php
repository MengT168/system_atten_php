...
if ($op == 'del') {
    $del = "DELETE FROM academicyear_tbl WHERE AcademicYearID=$id";
...
if (isset($_POST['btn_save'])) {
    ...
    $campusen = $_POST['AcademicYear'];
    // Prepare SQL update statement
    $sql_update = "UPDATE academicyear_tbl SET
                        AcademicYear='$campusen'
                        ";

    // Include image update in SQL statement if an image is uploaded

    $sql_update .= " WHERE AcademicYearID=$id";
    ...
    $(document).ready(function(){
        swal({
            ...
            window.location.href = "?tag=list_academicyear";
        });
    });
    </script>
    ';
...
<body>
    <?php
    if ($op == 'edit') {
        $sql_edit = "SELECT * FROM academicyear_tbl WHERE AcademicYearID=$id ";
            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Academic Year Form Edit</h5>
                                <form class="row g-3" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" name="AcademicYear" value="<?php echo $rw_edit['AcademicYear'] ?>" />
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3" method="post" enctype="multipart/form-data">
                                    <table class="table table-striped" cellpadding="2">
                                        <thead>
                                            <th scope="col-2">AcademicYearID</th>
                                            <th scope="col">Academic Year</th>
                                            <th scope="col" colspan="3">Action</th>
                                        </thead>
                                        <?php
                                        include_once 'connect.php';
                                        $query = "Select * From academicyear_tbl";
                                        ...
                                        <tr>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <button class="btn btn-secondary">
                                                    <a class="text-light text-decoration-none" href="?tag=list_academicyear&op=edit&id=' . $row['AcademicYearID'] . '">Edit</a>
                                                </button>                                            
                                            </td>

                                            <td>
                                                <button class="btn btn-danger">
                                                <a href="?tag=list_academicyear&op=del&id=' . $row['AcademicYearID'] . '" class="text-light text-decoration-none">Delete</a>                                                </button>
                                            </td>
                                                </tr>
                                            ';
                                            }
