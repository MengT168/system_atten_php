...
<body>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-2 hidden" id="refreshBtnContainer">
                                    <a id="searchNameBtn" style="margin-top: 30px;" href="?tag=batch_stu_report&op=search&batch=<?php echo $batch = isset($_GET['batch']) ? $_GET['batch'] : null; ?> " class="btn btn-primary">Refresh</a>
                                </div>
        ...
        <?php
        if (isset($_GET['op']) && $_GET['op'] == 'search' && isset($_GET['tag']) && $_GET['tag'] == 'batch_stu_report') {
            ...
            if ($batch !== null) {
                $query = "SELECT attendance_tbl.Attended, studentinfo_tbl.NameInLatin, faculty_tbl.FacultyEN, major_tbl.MajorEN, semester_tbl.SemesterEN, 
                          ...
                          WHERE attendance_tbl.Attended = 3 AND batch_tbl.BatchID=$batch";
    ...
    <script>
        document.getElementById('searchMajorBtn').addEventListener('click', function(event) {
            ...
            var url = '?tag=batch_stu_report&op=search';
