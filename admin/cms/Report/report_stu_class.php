...
<body>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-2 hidden" id="refreshBtnContainer">
                                    <a id="refreshBtn" style="margin-top: 30px;" href="?tag=class_stu_report&op=search&room=<?php echo $room = isset($_GET['room']) ? $_GET['room'] : null; ?>" class="btn btn-primary">Refresh</a>
                                </div>
        ...
        <?php
        if (isset($_GET['op']) && $_GET['op'] == 'search' && isset($_GET['tag']) && $_GET['tag'] == 'class_stu_report') {
                    ...
                    if ($proId !== null) {
                        $query = "SELECT attendance_tbl.Attended, studentinfo_tbl.NameInLatin, faculty_tbl.FacultyEN, major_tbl.MajorEN, semester_tbl.SemesterEN, 
                          ...
                          subject_tbl.SubjectEN, attendance_tbl.DateIssue , academicyear_tbl.AcademicYear
                                  ...
                                  WHERE attendance_tbl.Attended = 3 AND room_tbl.RoomID = $room AND schedule_tbl.ProgramID = $proId
                                  ";
    ...
    <script>
        document.getElementById('searchRoomBtn').addEventListener('click', function(event) {
            ...
            var url = '?tag=class_stu_report&op=search';
