...
<body>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-2 hidden" id="refreshBtnContainer">
                                    <a id="searchNameBtn" style="margin-top: 30px;" href="?tag=shift_stu_report&op=search&shift=<?php echo $shift = isset($_GET['shift']) ? $_GET['shift'] : null; ?> "class="btn btn-primary">Refresh</a>
                                </div>
        ...
        <?php
        if (isset($_GET['op']) && $_GET['op'] == 'search' && isset($_GET['tag']) && $_GET['tag'] == 'shift_stu_report') {
            ...
            if ($shift !== null) {
                $query = "SELECT attendance_tbl.Attended, studentinfo_tbl.NameInLatin, faculty_tbl.FacultyEN, major_tbl.MajorEN, semester_tbl.SemesterEN, 
                          ...
                          WHERE attendance_tbl.Attended = 3 AND shift_tbl.ShiftID=$shift";
    ...
    <script>
        document.getElementById('searchMajorBtn').addEventListener('click', function(event) {
            ...
            var url = '?tag=shift_stu_report&op=search';
