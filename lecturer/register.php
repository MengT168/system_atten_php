...
<?php
    ...
    if(isset($_POST['btnsignUp'])){
        ...
        $sql_check_id = "SELECT LecturerID FROM lecturer_tbl WHERE LecturerID = '$lecId'";
        $result = $conn->query($sql_check_id);

        if($result && $result->num_rows > 0){
            // If studentId exists
            $sql_check= "SELECT * FROM lecturer_login_tbl WHERE LecturerID='$lecId'";
            ...
            if($count > 0){
                ...
                $sql_ins = "INSERT INTO `lecturer_login_tbl`(`username`, `password`, `LecturerID`) VALUES ('$uname','$pass','$lecId')";
